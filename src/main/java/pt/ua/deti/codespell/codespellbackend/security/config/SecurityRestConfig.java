package pt.ua.deti.codespell.codespellbackend.security.config;
...
import pt.ua.deti.codespell.codespellbackend.security.auth.AuthEntryPoint;
import pt.ua.deti.codespell.codespellbackend.security.auth.AuthRequestFilter;
...
public class SecurityRestConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://159.65.60.64:3000", "https://dev.codespell.live", "https://codespell.live"));
